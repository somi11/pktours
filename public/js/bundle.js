...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //add maerker
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (session) {
              ...
              location.assign(session.data.sess); //showAlert('success', 'Processing');
